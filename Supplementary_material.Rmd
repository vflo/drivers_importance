...
![](~/Drivers_importance/plots/AGU_image.png)


*Global Biogeochemical Cycles*\par
\par
...
Víctor Flo$^{1}$, Jordi Martínez-Vilalta$^{1,2}$, Víctor Granda$^{1}$, Maurizio Mencuccini$^{1,3}$, Rafael Poyatos$^{1,2}$\par
\footnotesize
...
$^{3}$ICREA, Barcelona 08010, Spain\par
\par
\normalsize
\ecenter
\par
