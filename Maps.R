...
P_PET <- raster("~/[databases]/PPET_seasonality/P_PET.tif")
P_PETsd <- raster("~/[databases]/PPET_seasonality/P_PETsd.tif")
PET <- raster("~/[databases]/PPET_seasonality/annualPET.tif")
names(PET) <- "PET"
...
P_PET <- crop(P_PET,LAI,progress="text")
P_PETsd <- crop(P_PETsd,LAI,progress="text")
PET <- crop(PET,LAI,progress="text")
...
P_PET <- aggregate(P_PET,fact=6,progress="text")
P_PETsd <- aggregate(P_PETsd,fact=6,progress="text")
PET <- aggregate(PET,fact=6,progress="text")
...
P_PET <- raster::resample(P_PET,LAI,progress="text")
P_PETsd <- raster::resample(P_PETsd,LAI,progress="text")
PET <- raster::resample(PET,LAI,progress="text")
clay <- clay/10
sand <- sand/10
...
writeRaster(MAT,"~/Chapter_2_mod/data/rasters/MAT_resample.tif")
writeRaster(MAP,"~/Chapter_2_mod/data/rasters/MAP_resample.tif")
writeRaster(BIO_4,"~/Chapter_2_mod/data/rasters/BIO_4_resample.tif")
writeRaster(BIO_15,"~/Chapter_2_mod/data/rasters/BIO_15_resample.tif")
writeRaster(LAI,"~/Chapter_2_mod_mod/data/rasters/LAI_resample.tif")
writeRaster(st_height,"~/Chapter_2_mod_mod/data/rasters/st_height_resample.tif")
writeRaster(clay,"~/Chapter_2_mod/data/rasters/clay_resample.tif",overwrite=TRUE)
writeRaster(sand,"~/Chapter_2_mod/data/rasters/sand_resample.tif",overwrite=TRUE)
writeRaster(bedrock,"~/Chapter_2_mod/data/rasters/bedrock_R_resample.tif",overwrite=TRUE)
writeRaster(MO,"~/Chapter_2_mod/data/rasters/MO_resample.tif")
writeRaster(PPET,"~/Chapter_2_mod/data/rasters/PPET_resample.tif")
writeRaster(LAI_google,"~/Chapter_2_mod/data/rasters/LAI_google_resample.tif")
writeRaster(nitrogen,"~/Chapter_2_mod/data/rasters/nitrogen_resample.tif",overwrite=TRUE)
writeRaster(ph,"~/Chapter_2_mod/data/rasters/ph_resample.tif",overwrite=TRUE)
writeRaster(TOTN,"~/Chapter_2_mod/data/rasters/TOTN_resample.tif")
writeRaster(elevation,"~/Chapter_2_mod/data/rasters/elevation_resample.tif")
writeRaster(P_PET,"~/Chapter_2_mod/data/rasters/P_PET_resample.tif")
writeRaster(P_PETsd,"~/Chapter_2_mod/data/rasters/P_PETsd_resample.tif")
writeRaster(PET,"~/Chapter_2_mod/data/rasters/PET_resample.tif")
